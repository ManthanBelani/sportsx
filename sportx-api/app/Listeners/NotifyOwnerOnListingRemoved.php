...
class NotifyOwnerOnListingRemoved
{
    public function handle(ListingRemoved $event): void
    {
        ...
        NotificationService::createStatic([
            ...
            'body' => "Your {$typeLabel} \"{$name}\" was removed for policy violation. Contact support for more information.",
